...
extern "C" MEMORYMANIPULATION_API int ReadIntFromMemory(const char* address);
extern "C" MEMORYMANIPULATION_API double ReadDoubleFromMemory(const char* address);
extern "C" MEMORYMANIPULATION_API short ReadShortFromMemory(const char* address);
